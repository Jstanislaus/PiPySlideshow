...
while True:
    ...
    if i ==count:
        i=0
    if j%5==3:
        gpout = subprocess.Popen("rsync -avz -e ssh pi@192.168.1.155:Photobooth-printer-management/Photobooth_printer_management/Template/AH_2023_04_01_Phils_40th/Final_Templates/ PiPySlideshow",shell =True) 
        gpout1=gpout.wait()
        piclist = updatepics(path,piclist)
        random.shuffle(piclist)
